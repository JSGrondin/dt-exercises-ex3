...
def detect_onnx(sess_ort_path, img, official=True):
    ...
    session = onnxruntime.InferenceSession(sess_ort_path)
...
if __name__ == '__main__':
    ...
    image_path = '/home/js/PycharmProjects/dt-exercises/object_detection_ex3_det/yolo_dataset/images/val/430.png'
    image_src = Image.open(image_path)
    img = np.asarray(image_src)
    with torch.no_grad():
        detections = detect_onnx(sess_ort_path='/home/js/PycharmProjects/dt-exercises/object_detection_ex3_det/exercise_ws/checkpoints/detection_f.onnx',
                                 official=False, img=img)
